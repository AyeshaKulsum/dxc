...
public class Customer {
	...
	private void checkID(int customerId) throws InvalidCustomerIdException {
		if (customerId < 0)
			throw new InvalidCustomerIdException("Customer ID should not be negative");
		else
			this.customerId = customerId;
	}

	private void check(int billAmount) throws InvalidBillException {
		if (billAmount < 0)
			throw new InvalidBillException("Bill should not be negative");
		else
